...
% Définition de la commande DrawGrid avec condition
\newcommand\DrawGrid{
...
\begin{figure}[htbp]
    ...
    \includegraphics[
        ...
        height=0.4\textheight,  % 40% de la hauteur du texte
        keepaspectratio         % Maintient le ratio d'aspect pour éviter la déformation
    ]{images/chapitre1/therapie-naturelle.jpg}
...
\begin{figure}[htbp]
    ...
    \includegraphics[
        ...
        height=0.4\textheight,  % 40% de la hauteur du texte
        keepaspectratio         % Maintient le ratio d'aspect pour éviter la déformation
    ]{images/chapitre1/kasbah-talouet.jpg}
...
\begin{figure}[htbp]
    ...
    \includegraphics[
        ...
        height=0.4\textheight,  % 40% de la hauteur du texte
        keepaspectratio         % Maintient le ratio d'aspect pour éviter la déformation
    ]{images/chapitre1/bougie-main-cire-cadeau.jpg}
...
\begin{figure}[htbp]
    ...
    \includegraphics[
        ...
        height=0.4\textheight,  % 40% de la hauteur du texte
        keepaspectratio         % Maintient le ratio d'aspect pour éviter la déformation
    ]{images/chapitre2/outils-bougies-plan-travail.jpg}
...
\begin{figure}[htbp]
    \centering
    \begin{subfigure}[b]{0.45\textwidth} % Largeur de 45% du texte
        \includegraphics[width=\textwidth]{images/chapitre2/cire-soja.jpg}
        \caption{Cire de soja blanche pour la fabrication de bougies.}
        \label{fig:cire_soja}
    \end{subfigure}
    \hfill % Espace entre les deux images
    \begin{subfigure}[b]{0.45\textwidth} % Largeur de 45% du texte
        \includegraphics[width=\textwidth]{images/chapitre2/cire-parrafine-solide.jpg}
...
\begin{figure}[htbp]
    ...
    \includegraphics[
        ...
        height=0.4\textheight,  % 40% de la hauteur du texte
        keepaspectratio         % Maintient le ratio d'aspect pour éviter la déformation
    ]{images/chapitre2/cire-noix-coco.jpg}
...
\begin{figure}[htbp]
    \centering
    \begin{subfigure}[b]{0.45\textwidth} % Largeur de 45% du texte
        \includegraphics[width=\textwidth]{images/chapitre2/vibar.jpg}
...
\begin{figure}[htbp]
    ...
    \includegraphics[
        ...
        height=0.4\textheight,  % 40% de la hauteur du texte
        keepaspectratio         % Maintient le ratio d'aspect pour éviter la déformation
    ]{images/chapitre2/process-coloration.jpg}
...
\begin{table}[htbp]
    ...
    \setlength{\tabcolsep}{10pt} % Espacement entre colonnes
...
\begin{figure}[htbp]
    ...
    \includegraphics[
        ...
        height=0.4\textheight,  % 40% de la hauteur du texte
        keepaspectratio         % Maintient le ratio d'aspect pour éviter la déformation
    ]{images/chapitre2/moule-sillicone.jpg}
...
\begin{figure}[htbp]
    ...
    \includegraphics[
        ...
        height=0.4\textheight,  % 40% de la hauteur du texte
        keepaspectratio         % Maintient le ratio d'aspect pour éviter la déformation
    ]{images/chapitre2/moule-elegance.jpg}
...
\begin{figure}[htbp]
    ...
    \includegraphics[
        ...
        height=0.4\textheight,  % 40% de la hauteur du texte
        keepaspectratio         % Maintient le ratio d'aspect pour éviter la déformation
    ]{images/chapitre2/boulloire-eau.jpg}
...
\begin{figure}[htbp]
    ...
    \includegraphics[
        ...
        height=0.4\textheight,  % 40% de la hauteur du texte
        keepaspectratio         % Maintient le ratio d'aspect pour éviter la déformation
    ]{images/chapitre2/thermometre-cuisine.jpg}
...
\begin{figure}[htbp]
    ...
    \includegraphics[
        ...
        height=0.4\textheight,  % 40% de la hauteur du texte
        keepaspectratio         % Maintient le ratio d'aspect pour éviter la déformation
    ]{images/chapitre2/batonnet-bois.jpg}
...
\begin{figure}[htbp]
    ...
    \includegraphics[
        ...
        height=0.4\textheight,  % 40% de la hauteur du texte
        keepaspectratio         % Maintient le ratio d'aspect pour éviter la déformation
    ]{images/chapitre4/bougie-pot.jpg}
...
\begin{figure}[htbp]
    ...
    \includegraphics[
        ...
        height=0.4\textheight,  % 40% de la hauteur du texte
        keepaspectratio         % Maintient le ratio d'aspect pour éviter la déformation
    ]{images/chapitre5/bougie-bubble.jpg}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.5\textwidth]{Pictures/images/chapitre6/flamme-bougies-noir.jpg}
