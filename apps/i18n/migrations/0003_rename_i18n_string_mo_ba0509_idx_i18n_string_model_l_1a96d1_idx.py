...
def _rename_index_forwards(apps, schema_editor):
    ...
    old_index = models.Index(fields=['model_label', 'object_id', 'field', 'language'], name='i18n_string_mo_ba0509_idx')
    new_index = models.Index(fields=['model_label', 'object_id', 'field', 'language'], name='i18n_string_model_l_1a96d1_idx')
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('i18n', '0002_rename_i18n_string_mo_ba0509_idx_i18n_string_model_l_1a96d1_idx'),
    ]
