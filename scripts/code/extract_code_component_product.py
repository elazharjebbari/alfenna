...
BASE_DIRS = [
    ...
    Path("C:\\Users\\Utilisateur\\PycharmProjects\\alfenna\\templates\\components\\core\\product\\manifest.yml"),
...
TARGET_FILES: List[os.PathLike | str] = [
    # Exemples:
    # Path("C:\\Users\\Utilisateur\\PycharmProjects\\alfenna\\static\\js\\flowforms.runtime.js"),
